<?php
  ...
  if(empty($_SESSION['id_user'])) {
    $_SESSION['callFrom'] = "apply-intern-post.php?id=".$_GET[id];
...
<html lang="en">
  ...
  <div style="background-color: #053a5a; height: 80px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 75px;">Internship Details</p>
  </div>
      ...
      $result = $conn->query($sql);
        ...
        <table align="center">
          ...
          <tr style="font-size: 26px;">
            <td style="color: #053a5a;"><strong>Internship Title</strong></td>
            <td style="color: #053a5a;"> &nbsp;&nbsp;&nbsp;<strong>:</strong> </td>
            <td>&nbsp;&nbsp;&nbsp;<?php echo $row['interntitle']; ?></td>
          </tr>
          ...
          <tr style="font-size: 26px;">
            <td style="color: #053a5a;"><strong>Internship Description</strong></td>
            <td style="color: #053a5a;"> &nbsp;&nbsp;&nbsp;<strong>:</strong> </td>
          ...
          <tr>
            <td></td>
            <td></td>
            <td><a href="apply1.php?id=<?php echo $row['id_internpost']; ?>" style="background-color: #053a5a; border-color: transparent; border-radius: 5px; padding-left: 25px; padding-right: 25px; padding-top: 10px; padding-bottom: 13px; color: white; font-size: 24px; text-decoration: none;">Apply</a></td>
          </tr>
